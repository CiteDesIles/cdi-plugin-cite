...
public class ItemsLists {
    ...
    public void initLists() {
        ...
        upgrade.put(new ItemStack(Material.COBBLESTONE), 1500L);
        upgrade.put(new ItemStack(Material.DIRT), 1500L);
        upgrade.put(new ItemStack(Material.SMOOTH_SANDSTONE_SLAB), 1000L);
        upgrade.put(new ItemStack(Material.RED_SANDSTONE_WALL), 800L);
        upgrade.put(new ItemStack(Material.RED_NETHER_BRICK_STAIRS), 700L);
        upgrade.put(new ItemStack(Material.POLISHED_DIORITE), 500L);
        upgrade.put(new ItemStack(Material.WARPED_STAIRS), 300L);
        upgrade.put(new ItemStack(Material.COPPER_BLOCK), 150L);
        upgrade.put(new ItemStack(Material.MANGROVE_TRAPDOOR), 100L);
        upgrade.put(new ItemStack(Material.GRAY_BED), 100L);
        upgrade.put(new ItemStack(Material.REDSTONE_BLOCK), 100L);
        upgrade.put(new ItemStack(Material.IRON_BLOCK), 50L);
        upgrade.put(new ItemStack(Material.EMERALD_BLOCK), 10L);
        upgrade.put(new ItemStack(Material.DIAMOND_SWORD), 16L);
        upgrade.put(new ItemStack(Material.DIAMOND_PICKAXE), 2L);
