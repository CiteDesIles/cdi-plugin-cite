...
public class ArrowShootOnPlayerRankingHologram {
    public static void init() {
        ...
        TextHologramData textHologramData = new TextHologramData("cdi.archerranking", new Location(Bukkit.getWorld("world"), 100.5, 97, -371.5));
        ...
        textHologramData.setText(List.of("§6§lClassement des archers", "§7Loading..."));
    ...
    public static void refresh() {
        ...
        List<String> lines = new ArrayList<>();
        lines.add("§6§lClassement des archers");
        int position = 1;
